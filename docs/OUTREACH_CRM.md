...
## Drafted, not yet sent (owner action: open draft in Gmail web UI, replace `[קישור לדף השותפים]` with `https://israel-counterparty-intelligence.vercel.app/partner/he` (Hebrew partner page, no crypto talk; the English `/partner` stays for technical readers), send)
