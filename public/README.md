...
Status: **MAINNET LIVE — first external paid call confirmed** (paid x402 endpoints available; free previews available; no customer logos)

Paid reports, wallet handoff, and x402 Mainnet payments are available again. Unpaid paid-route POSTs return HTTP 402 with PAYMENT-REQUIRED. Check [STATUS](https://israel-counterparty-intelligence.vercel.app/STATUS.md), [health](https://israel-counterparty-intelligence.vercel.app/health), and [x402 discovery](https://israel-counterparty-intelligence.vercel.app/.well-known/x402) before paying.
